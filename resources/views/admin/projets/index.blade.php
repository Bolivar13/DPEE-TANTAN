        ...
        <x-slot name="header">
            <div class=" col-12" style="display: flex;justify-content: space-between;">
                ...
                <div class="btn d-flex align-items-center btn-info">
                    <a href="adminprojet/create" class="align-items-center d-flex">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg d-flex flex-wrap ">
                    <div class="d-flex justify-content-center flex-wrap">
                        ...
                        <div class="card m-4 sp1 d-flex justify-content-center " style="width: 18rem;   ">
                            <a class="card-body text-center" href="{{url('/adminprojet/'.$projet->id.'/show')}}">
                                <img src="{{asset('/storage/projetsPicture'.'/' . $projet->image)}}" class="mmg justify-content-center d-flex" alt="">
                                <h1 class="card-title mt-3">{{$projet->title}}</h1>
                                <div class="d-flex justify-content-center">
                                    <h4 class="card-title d-flex align-items-center mt-3 text-success fw-bold">
                                        <span>
                                            Durée:
                                        </span>
                                        <span>
