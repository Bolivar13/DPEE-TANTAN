...
<body>
    ...
    <section>
        ...
        <div class="content d-flex justify-content-start col-10">
            <div class="fs-1 fw-bold">{{$projet->title}}</div>
            <div class="d-flex align-items-center">
                <div class="text-nowrap fs-3 fw-bold">La Durée:</div>
                <div class="ms-3">{{$projet->duree}}</div>
            </div>
